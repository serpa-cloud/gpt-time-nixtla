...
declare module 'react-router-dom' {
  ...
  declare export function createRoutesFromChildren(children: React$Node): Array<RouteObject>;
  ...
  declare export function createSearchParams(init?: URLSearchParamsInit): URLSearchParams;
}
